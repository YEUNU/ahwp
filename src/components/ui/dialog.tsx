/* eslint-disable react-refresh/only-export-components -- shadcn re-exports the
 * Radix Root/Trigger/Close primitives as constants alongside the wrapped
 * components. These are stable references shared with the shadcn ecosystem;
 * splitting them into a separate file would diverge from the shadcn template.
 */
