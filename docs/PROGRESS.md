...
| 항목        | 상태                                                                                                                                                                                                                                                                                                                                                           |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Phase       | **Phase 6.2 (chunks 100~102)** — rhwp-studio view 계층 정합 진행 중. 6.0 `WasmBridge` + 6.1 `coordinate-system.ts` + 6.2 `canvas-pool` / `render-mode` 인프라 완료. 잔여 chunks 103~107 ([PHASE6_PLAN.md](PHASE6_PLAN.md)). Phase 5 chunks 다수 + chunk 99 follow-up batch 완료 — 상세는 ROADMAP / CHANGELOG. 외부 의존 잔여: Anthropic API 키 대기 (chunk 42) |
| 버전        | `0.3.43`                                                                                                                                                                                                                                                                                                                                                       |
...
| 103   | Phase 6.3 — Canvas 본문 렌더 + L-004 tooltip 대체 + 비동기 이미지 재렌더                                                                                      | 다음 |
