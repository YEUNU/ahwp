...
| 항목        | 상태                                                                                                                                                                                                                       |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Phase       | **Phase 2 청크 5** — assistant 메시지 마크다운 + 코드 syntax highlight. 다음: 메시지 액션 / 히스토리 / Manual diff                                                                                                         |
...
| e2e         | ✅ 159 케이스 / 4 워커 병렬 (~60s) — 153 prior + 6 markdown. 12 skip = 11 BIG_FIXTURE + 1 NIM live(env)                                                                                                                    |
