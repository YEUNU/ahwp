...
| 항목        | 상태                                                                                                                                                                                                                       |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Phase       | **Phase 2 청크 2** — OpenAI 스트리밍 + ChatPanel 골격. 다음: Settings 모달 + 추가 provider                                                                                                                                 |
...
- Settings 모달 (shadcn dialog) — provider 토글 + 키 입력 폼 + 연결 테스트 (`ai:ping` IPC + provider.ping 사용). 키 입력 후 즉시 input clear
...
- BYOK Settings 모달 UI (provider 토글 + 키 폼 + 연결 테스트 — `ai:ping` IPC)
- 추가 provider 어댑터 — Anthropic / Google / NVIDIA NIM / Ollama / 커스텀
...
- e2e 게이트: mock fetch로 `ai:chat` 라운드트립 검증
