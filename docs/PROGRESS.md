...
| 항목        | 상태                                                                                                                                                                                                                       |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Phase       | **Phase 2 청크 6 + dep 업그레이드** — 메시지 액션, `@rhwp/core` 0.7.9 (insert/deleteParagraph). 다음: 채팅 히스토리 / Manual diff                                                                                          |
...
| e2e         | ✅ 167 케이스 / 4 워커 병렬 (~69s) — 165 prior + 2 paragraph-ops. 1 skip = NIM live(env)                                                                                                                                   |
