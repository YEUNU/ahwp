...
| 항목        | 상태                                                                                                                                                                                                                                                                                             |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Phase       | **Phase 3 MVP (Agent 모드, chunks 37~41)** — provider native tool-use API 정식 통합, Manual/Agent 토글, AI 도구 자동 호출 + 묶음 undo. Phase 2 마무리 + 1/2/3차 UX 라운드 모두 완료. 잔여 (외부 의존): chunks 42/43 (Anthropic/Google API 키 대기) / chunks 44~47 (사용자 피드백 받아 점진 추가) |
| 버전        | `0.3.0`                                                                                                                                                                                                                                                                                          |
...
| e2e         | ✅ 268 케이스 · studio 213 + chat 54 + 1 skipped · live NIM smoke 별도                                                                                                                                                                                                                           |
