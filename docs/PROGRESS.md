...
| 항목        | 상태                                                                                                                                                                                                                       |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Phase       | **Phase 2 청크 6** — 메시지 액션 (복사/재생성/삭제). 2-C 완료. 다음: 채팅 히스토리 / Manual diff                                                                                                                           |
...
| e2e         | ✅ 165 케이스 / 4 워커 병렬 (~68s) — 159 prior + 6 message-actions. 1 skip = NIM live(env). BIG_FIXTURE 마이그레이션으로 11개 활성화                                                                                       |
