...
| 항목        | 상태                                                                                                                                                                                                                                                                                                      |
| ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Phase       | **Phase 4 진입 (chunks 52~54)** — Agent 모드 + Google Gemini + tool 카탈로그 **54개** (write 45 + read 9). 양식 매칭 워크플로우 (read → reason → write) + system prompt 가이드. 잔여 (외부 의존): chunk 42 (Anthropic — API 키 대기), chunk 44 (Custom capability flag), chunk 50 (docId-aware multi-doc) |
| 버전        | `0.3.6`                                                                                                                                                                                                                                                                                                   |
