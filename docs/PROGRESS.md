...
| 항목        | 상태                                                                                                                                                                                                                       |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Phase       | **Phase 2 청크 3** — NVIDIA NIM provider + provider/model 셀렉터 + chat e2e (10) + 병렬 워커. 다음: Settings 모달 + 마크다운/히스토리                                                                                      |
...
| e2e         | ✅ 144 케이스 / 4 워커 병렬 (~55s, 1 워커 132s 대비 2.4×) — 144 = 134 + 10 chat. live NIM은 `NVAPI_KEY`로 게이트                                                                                                           |
