...
| 항목        | 상태                                                                                                                                                                                                                                                                                                                         |
| ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Phase       | **Phase 2 + 1차 UX 라운드 (chunks 50~55)** — Phase 2 사용자-facing + 명령 팔레트(⌘K) + status bar 단어/글자 카운터 + 자동 저장(60s .draft) + 단축키 치트시트(⌘/) + 다크 모드 본문 종이 흰색 + 탭 고정(📌). 다음: 2차 UX 라운드(chunks 56~60) — AI 우클릭 메뉴 / AI inline diff / 목차 사이드바 / PDF 미리보기 / 검색 in 폴더 |
| 버전        | `0.2.55`                                                                                                                                                                                                                                                                                                                     |
...
| e2e         | ✅ 303 케이스 · 296 passed / 6 skipped (NIM 키 게이트 5 + cell-menu 1) · live NIM 5/5 (`qwen/qwen3.5-122b-a10b`)                                                                                                                                                                                                             |
