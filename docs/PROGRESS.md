...
| 항목        | 상태                                                                                                                                                                                                                                                                                                                                     |
| ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Phase       | **Phase 6.0 진입 (chunk 100)** — rhwp-studio view 계층 정합 시작 (`WasmBridge` 추상). 잔여 chunks 101~107 ([PHASE6_PLAN.md](PHASE6_PLAN.md)). Phase 5 chunks 다수 + chunk 99 follow-up batch (Plan mode + Outline-aware section replace + 자동 적용) 완료 — 상세는 ROADMAP / CHANGELOG. 외부 의존 잔여: Anthropic API 키 대기 (chunk 42) |
| 버전        | `0.3.41`                                                                                                                                                                                                                                                                                                                                 |
