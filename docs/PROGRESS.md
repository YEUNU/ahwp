...
| 항목        | 상태                                                                                                                                                                                                                                                                                                                                                                             |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Phase       | **Phase 6.1 (chunks 100~101)** — rhwp-studio view 계층 정합 진행 중. 6.0 `WasmBridge` 추상 + 6.1 `coordinate-system.ts` 완료. 잔여 chunks 102~107 ([PHASE6_PLAN.md](PHASE6_PLAN.md)). Phase 5 chunks 다수 + chunk 99 follow-up batch (Plan mode + Outline-aware section replace + 자동 적용) 완료 — 상세는 ROADMAP / CHANGELOG. 외부 의존 잔여: Anthropic API 키 대기 (chunk 42) |
| 버전        | `0.3.42`                                                                                                                                                                                                                                                                                                                                                                         |
...
| 102   | Phase 6.2 — `canvas-pool` + dual-mode (`localStorage.ahwp:render-mode`) 인프라                                                  | 다음 |
