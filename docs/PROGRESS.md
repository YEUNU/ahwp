...
| 항목        | 상태                                                                                                                                                                                                                       |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Phase       | **Phase 2 청크 7** — 찾아 바꾸기 (⌘H, replaceOne/replaceAll IR), examples/ git 추적, e2e retry=1. 다음: rhwp-core API 추가 활용 (셀 합치기, 줄간격, 머리말 등)                                                             |
...
| e2e         | ✅ 173 케이스 / 4 워커 병렬 + retry=1 (~75s) — 167 prior + 6 replace. 1 skip = NIM live(env)                                                                                                                               |
...
**다음 청크 — rhwp-core API 추가 활용 (사용자 요청 방향)**
...
- rhwp-core API 추가 활용 시리즈 (셀 합치기 → 줄간격 → 머리말 → 각주 → 페이지 설정 등 — 위 일지의 "다음 청크" 표 참조)
